class Enemies {
  ...
  animate() {
    for (var i = 0; i < this.enemies.length; ++i) {
      ...
      if (this.enemies[1].position.x >= 100 && this.direction[1] == "left") {
        this.enemies[1].applyCentralImpulse(new THREE.Vector3(-this.force, 0, 0));
        this.direction[1] = "right";
      }
      else if (this.enemies[1].position.x <= -100 && this.direction[1] == "right") {
        this.enemies[1].applyCentralImpulse(new THREE.Vector3(this.force, 0, 0));
        this.direction[1] = "left";
      }

      if (this.enemies[2].position.x >= 100 && this.direction[2] == "left") {
        this.enemies[2].applyCentralImpulse(new THREE.Vector3(-this.force, 0, 0));
        this.direction[2] = "right";
      }
      else if (this.enemies[2].position.x <= -100 && this.direction[2] == "right") {
        this.enemies[2].applyCentralImpulse(new THREE.Vector3(this.force, 0, 0));
        this.direction[2] = "left";
      }

      if (this.enemies[3].position.x >= 100 && this.direction[3] == "left") {
        this.enemies[3].applyCentralImpulse(new THREE.Vector3(-this.force, 0, 0));
        this.direction[3] = "right";
      }
      else if (this.enemies[3].position.x <= -100 && this.direction[3] == "right") {
        this.enemies[3].applyCentralImpulse(new THREE.Vector3(this.force, 0, 0));
